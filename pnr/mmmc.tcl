...
# If you have multiple .lib files put them in a [list lib1 lib2] structure:Lx
create_library_set -name typical_lib \
   -timing [list /home/ece6770/s22/allen_boston/lab7/scadv12_cmos10sf_rvt_tt_1p0v_25c.lib]
...
create_constraint_mode -name typical_constraint \
   -sdc_files ../pnr/design_files/arbiter.dcopt.sdc
#################################################################
