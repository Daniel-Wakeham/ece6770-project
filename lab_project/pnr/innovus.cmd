...
#  Created on Sat May  7 13:20:01 2022                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.973468 -from {0x10 0x13} -to 0x14 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.973468 -from {0x17 0x1a} -to 0x1b -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.973468 -from 0x1d -to 0x1e
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.973468 -from 0x21 -to 0x22
setPathGroupOptions reg2reg_tmp.973468 -effortLevel high
isAnalysisModeSetup
...
reset_path_group -name reg2out_tmp.973468
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.973468
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.973468
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.973468
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.973468 -from {0x2c 0x2f} -to 0x30 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.973468 -from {0x33 0x36} -to 0x37 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.973468 -from 0x39 -to 0x3a
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.973468 -from 0x3d -to 0x3e
setPathGroupOptions reg2reg_tmp.973468 -effortLevel high
reset_path_group -name reg2out_tmp.973468
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.973468
